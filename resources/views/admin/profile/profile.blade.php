            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        @if (Auth::user()->image)
                        <img src="{{ asset('images/' . Auth::user()->image) }}">@else<img
                                src="{{ asset('assets/img/profile-img.jpg') }}" alt="Profile" class="rounded-circle">
                        @endif
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ Auth::user()->name ?? 'NA' }}</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ Auth::user()->country ?? 'NA' }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Address</div>
                                    <div class="col-lg-9 col-md-8">{{ Auth::user()->address ?? 'NA' }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Phone</div>
                                    <div class="col-lg-9 col-md-8">{{ Auth::user()->mobile ?? 'NA' }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Email</div>
                                    <div class="col-lg-9 col-md-8">{{ Auth::user()->email ?? 'NA' }}</div>
                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            @if (Auth::user()->image)
                                                ...
                                                alt="Profile">@else<img src="assets/img/profile-img.jpg"
                                                    alt="Profile">
                                            @endif
                                            <div class="pt-2">
                                                <a href="#" class="btn btn-primary btn-sm"
                                                    title="Upload new profile image"><input type="file" name="image"><i
